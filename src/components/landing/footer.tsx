      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2"><Mail className="h-5 w-5 text-primary" /><span className="text-muted-foreground">info@mediagenda.com</span></li>
              <li className="flex items-start gap-2"><Phone className="h-5 w-5 text-primary" /><span className="text-muted-foreground">+34 900 123 456</span></li>
              <li className="flex items-start gap-2"><MapPin className="h-5 w-5 text-primary" /><span className="text-muted-foreground">Calle Principal 123, Madrid, España</span></li>
            </ul>
          </div>
        </div>
