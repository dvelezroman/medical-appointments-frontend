...
export default function Features() {
  ...
  return (
    <section id="features" className="py-20 bg-muted/50 transition-colors duration-300 ease">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
               className="rounded-lg p-6 shadow-md border border-white/10 bg-white/10 backdrop-blur-lg hover:shadow-md transition-shadow"
            >
